...
//get_post_meta() for retrieving CUSTOM FIELDS.
//METABOX Framework as alternative to custom field
//METABOX Frameworks provide color picker, date picker and other functionalities.
//Always escape values before echoing them to the front page
